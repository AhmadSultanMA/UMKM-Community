...
import CardRiwayatKomunitas from "./CardRiwayatKomunitas";
import { dataRiwayatKomunitas } from "../data/dataKomunitas";

const dataDropdown = ["Terbaru", "Terlama"];

const RiwayatKomunitas = () => {
  ...
  return (
    <div className="cust-container py-10">
      ...
      <div className="flex flex-col gap-5 py-2">
        {dataRiwayatKomunitas.map((item, index) => {
          return <CardRiwayatKomunitas key={index} data={item} />;
        })}
      </div>
    </div>
  );
...
export default RiwayatKomunitas;
