    ...
    <div className="cust-container text-cust-primary900 flex flex-col gap-10 py-10">
      ...
      <div className="py-5 px-8 bg-[#D9D9D9] drop-shadow-[0px_3px_3px_rgba(0,0,0,0.3)] flex flex-col gap-3 relative rounded-2xl">
        ...
        <div className="grid grid-cols-4 gap-5 relative">
          <div className="absolute z-30 w-12 h-12 -right-14 cursor-pointer border border-cust-primary900 top-1/2 -translate-y-1/2 bg-white rounded-full">
          ...
          <div className="w-full relative">
            <img
              ...
              alt="img"
            />
            <p className="font-bold absolute right-1/2 translate-x-1/2 top-1/2 -translate-y-1/2 text-white text-lg">
              Perencanaan
            </p>
          </div>
          <div className="w-full relative">
