        ...
        <div className="mx-auto w-11/12 flex justify-between">
          <div className="relative md:w-4/12 w-6/12">
            <div
              ...
              className="bg-cust-secondary100 cursor-pointer w-11/12 z-20 flex md:gap-10 justify-between items-center py-2 px-3 lg:px-10 border-2 border-cust-primary900 rounded-full"
            >
          ...
          <div className="carousel  md:carousel-center carousel-start w-full">
            {data.map((item, i) => (
              <div className="xl:w-3/12 lg:w-4/12 mx-auto carousel-item">
                <div
                  className="w-10/12 mx-auto bg-cust-primary200 rounded-2xl shadow-lg pb-5 border-2 border-black"
                  key={i}
                >
