...
const Profile = () => {
  ...
  return (
    <div className="cust-container grid grid-cols-12 gap-5 py-10 max-h-min">
      <div className="col-span-4 lg:col-span-2 bg-[#DFF3F3] h-full lg:h-fit pt-2 pb-20 border border-cust-primary200 px-5 flex flex-col items-start justify-start lg:justify-center text-cust-primary900 font-medium">
        <h1
        ...
        <p
          className={`flex gap-2 items-center cursor-pointer text-xs sm:text-sm md:text-base hover:font-medium
        ...
        <Link
          to={"/"}
          className="flex gap-2 items-center cursor-pointer text-xs sm:text-sm md:text-base font-normal hover:font-medium"
        >
